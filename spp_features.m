function feat = spp_features(im, boxes, spp_model)
% feat = rcnn_features(im, boxes, spp_model)
...
if spp_model.cnn.init_key ~= caffe('get_init_key')
...
[batches, batch_padding] = spp_extract_regions(im, boxes, spp_model);
