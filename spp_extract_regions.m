function [batches, batch_padding] = spp_extract_regions(im, boxes, spp_model)
...
batch_size = spp_model.cnn.batch_size;
...
crop_mode = spp_model.detectors.crop_mode;
image_mean = spp_model.cnn.image_mean;
crop_size = size(image_mean,1);
crop_padding = spp_model.detectors.crop_padding;
